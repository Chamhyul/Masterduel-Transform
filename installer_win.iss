...
DisableDirPage=yes
LicenseFile=LICENSE
OutputBaseFilename=win_x64_MD_Transform.v0.1.3
OutputDir=.
...
[Messages]
WelcomeLabel1=MasterDuel Transform v0.1.3 (Windows) 설치를 시작합니다.
...
begin
  ...
  CurrentLS := (3 shl 16) or 0; // Build: 3, Revision: 0
  ...
  begin
    ...
    begin
      if MsgBox('MasterDuel Transform v0.1.3 버전이 이미 설치되어 있습니다.' + #13#10 + #13#10 +
